...
Page({
  ...
  data: {
    background: 'http://pangweihang.cn/modao/modao/xuexi.png',
    selected: true,
    ...
    selections: [{
        background: 'http://pangweihang.cn/modao/modao/qinghe.png',
        title: '温晁见清河势力尚存，不敢贸然发兵，江氏夫妇和余下族人得以幸存。\n\r云梦江氏和清河聂氏在不净世联合发动伐温之战，并力邀兰陵金氏、姑苏蓝氏加入。射日之征开始。',
        over: false,
        buttonword: '继续下一章'
      },
      {
        background: 'http://pangweihang.cn/modao/modao/gusu.png',
