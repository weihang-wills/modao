...
Page({
  ...
  data: {
    background: 'http://pangweihang.cn/modao/modao/qiongqidao.png',
    selected: true,
    ...
    selections: [
      ...
      {
        background: 'http://pangweihang.cn/modao/modao/yinhufu.png',
        title: '魏无羡伸手摸向随便，停下了手中的陈情，这时金子勋和金氏子弟摆脱了凶尸，立刻向无羡万箭齐发，无羡灵气微弱无法用剑，金子轩急忙帮忙格挡，仍挡不住几支利箭射向无羡，魏无羡身中箭死于穷奇道。',
        over: true,
        buttonword: '退出游戏'
      },
      {
        background: 'http://pangweihang.cn/modao/modao/qingxin.png',
