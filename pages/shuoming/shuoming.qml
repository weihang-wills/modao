...
class='background'
mode='widthFix'
src='http://pwh.img.jogiter.cn/modao/shuoming1.png'></image>
...
<view class='texts'>给道友们一个归属地，分享魔道同人的故事和内容，进行一些再创作的小游戏，最重要的是道友们一起开心，希望多多支持~</view>
<image class='title' mode='aspectFit' src='../../utils/3.png' />
